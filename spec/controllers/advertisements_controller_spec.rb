...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  let(:my_advertisement) {Advertisement.create!(title: RandomData.random_sentence,
     body: RandomData.random_paragraph, price: rand(00..20)) }
  ...
  describe "POST create" do
    ...
    it "assigns the new advertisement to @advertisement" do
      expect(my_advertisement).to eq Advertisement.last
    end
